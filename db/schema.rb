...
ActiveRecord::Schema.define(version: 20131209002528) do
  ...
  create_table "movie_book_locations", force: :cascade do |t|
    t.integer  "movie_id"
    t.integer  "book_id"
    t.integer  "page_id"
    t.datetime "created_at", null: false
  ...
  create_table "movie_performances", force: :cascade do |t|
    t.integer  "movie_id"
    t.integer  "person_id"
  ...
  create_table "steam_game_developers", force: :cascade do |t|
  ...
  create_table "steam_game_publishers", force: :cascade do |t|
    t.integer  "steam_app_id"
    t.integer  "company_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "steam_game_tags", force: :cascade do |t|
    t.string   "name"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "steam_games", force: :cascade do |t|
    ...
    t.text     "about_the_game_description"
  ...
  create_table "steam_tagged_games", force: :cascade do |t|
  ...
  create_table "steam_user_games", force: :cascade do |t|
